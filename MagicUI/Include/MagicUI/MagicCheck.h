...
///////////////////////////////////////////////////////////////////////////////////
#ifndef _MAGICUI_CHECK_H_
#define _MAGICUI_CHECK_H_
...
namespace GUI
{
class GUI_EXT_CLASS CMagicCheck : public CButton
{
	DECLARE_DYNCREATE(CMagicCheck)
// Construction
public:
	CMagicCheck();
	//重载创建函数
